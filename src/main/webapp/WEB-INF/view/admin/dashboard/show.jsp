    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <!-- Phần hiển thị các thống kê chính: User, Product, Order -->
                <div class="row">
                    <!-- Card thống kê số lượng User -->
                    ...
                    <!-- Card thống kê số lượng Product -->
                    <div class="col-xl-4 col-md-6">
...
<!-- Script: Bootstrap, Chart.js, DataTables; giữ nguyên thứ tự để tránh lỗi phụ thuộc -->
