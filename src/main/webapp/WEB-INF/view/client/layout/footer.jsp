        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p>My Channel: <a href="https://www.youtube.com/c/gi%C3%A1ol%C3%A0ng" target="_blank">Giao Lang</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="https://www.youtube.com/c/gi%C3%A1ol%C3%A0ng" target="_blank"><i
                                class="fas fa-copyright text-light me-2"></i>Giao Lang</a>, All right
                            reserved.</span>
            </div>
